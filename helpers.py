...
def load_checkpoint(param, use_checkpoint, device):
    ...
    if not use_checkpoint:
        print(f'./model/diff-params-ARGS={param}/checkpoint/diff_epoch=50.pt')
        return torch.load(f'./model/diff-params-ARGS={param}/checkpoint/diff_epoch=50.pt', map_location=device)
